  ...
  return (
    <div>
      ...
      <div className="absolute sm:inset-20 lg:left-8 md:top-80 lg:top-72 top-96 sm:top-96">
        ...
        <div className="flex">
          <button className="text-black m-auto  mt-12 px-12 p-4 rounded-xl bg-logo shadow-xl hover:bg-yellow-100  transition-all duration-500 font-courgette text-2xl ">
            Order Now
          </button>
        </div>
      </div>
