...
const MenuSlider = () => {
  ...
  return (
    <div className="menu-slider border-t-4 border-yellow-600 h-full">
      <div className="py-5">
        <div className="w-9/12 md:w-9/12 lg:w-7/12 menu-bg m-auto  sm:h-screen md:h-3/5">
            ...
            <div className="bg-menuBackground my-12 rounded-3xl ">
              <div className="grid md:grid-cols-2">
                ...
                <img
                  ...
                  className="menuImage md:border-l-4 border-b-4 md:border-b-0 border-yellow-200 order-first md:order-last md:rounded-r-3xl md:rounded-tl-none rounded-t-3xl rounded-tl-3xl "
                  alt=""
                />
              </div>
            </div>
